...
def _process_pdf_pages(
    pdf_path: Path, ocr_service: OCRService, start_time: float
) -> OCRResponse:
    """
    Process a PDF file by converting pages to images and extracting text.
    ...
    Returns:
        OCRResponse with combined text from all pages
    """
...
async def extract_text(request: Request, file: UploadFile = File(...)):
    ...
    try:
        ...
        if file.content_type == "application/pdf":
            return _process_pdf_pages(temp_path, ocr_service, start_time)
