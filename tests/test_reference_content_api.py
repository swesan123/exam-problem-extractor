...
class TestListClassReferenceContent:
    ...
    def test_list_reference_content_success(self, client, mock_embedding_service):
    ...
    def test_list_reference_content_empty(self, client, mock_embedding_service):
    ...
    def test_list_reference_content_service_error(self, client, mock_embedding_service):
...
class TestDeleteReferenceContent:
    ...
    def test_delete_reference_content_service_error(self, client, mock_embedding_service):
