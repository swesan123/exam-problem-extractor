...
def test_export_txt_with_solutions(client: TestClient, sample_class: Class, sample_questions):
...
def test_export_invalid_format(client: TestClient, sample_class: Class, sample_questions):
